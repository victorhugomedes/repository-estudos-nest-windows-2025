...
export class AddCoursesIdToCoursesTagsTable1761141832587 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.dropForeignKey('courses_tags', 'courses_tags_courses')// dropa o nome da tabela e nome da chave estrangeira

        await queryRunner.dropColumn('courses_tags', 'coursesId')//dropa o nome da tabela e nome da coluna 
