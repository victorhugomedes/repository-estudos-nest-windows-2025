...
export class AddTagsIdToCoursesTagsTable1761154269034 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
         await queryRunner.dropForeignKey('courses_tags_tags', 'courses_tags_tags')// dropa o nome da tabela e nome da chave estrangeira

        await queryRunner.dropColumn('courses_tags_tags', 'tagsId')//dropa o nome da tabela e nome da coluna 
